...
This approach has been exported into [yet another javascript library](https://github.com/wkrueger/redutser), just in case you are curious. I have also baked in a couple of another useful stuff. I've also later found out [rematch](https://github.com/rematch/rematch), which seems quite similar and straightforward (havent tested it enough myself tough).
